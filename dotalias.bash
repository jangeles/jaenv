...
alias uk='export UIKIT_HOME=$CODEBASE_HOME/../ui-kit ;cd $UIKIT_HOME ; export PATH=$UIKIT_HOME/build/yarn/yarn-v1.5.1/bin:$UIKIT_HOME/build/yarn/yarn-v1.5.1/bin:$UIKIT_HOME/build/nodejs/node-v8.9.4-darwin-x64/bin:$BASEPATH'
